...
def load_list(dataset_list, data_root):
    ...
    for dataset_name in dataset_list:
        ...
        for depth in depth_files:
            ...
            contours.append(depth_root.replace('/depth/', '/Boundary/') + depth[:-4]+'_edge.png')
...
class ImageData(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.mode == 'train':
            ...
            contour_7 = self.label_7_transform(new_contour)
            ...
            return new_img, new_depth, label_224, label_7, label_14, label_28, label_56, label_112, \
                   contour_224, contour_7, contour_14, contour_28, contour_56, contour_112
